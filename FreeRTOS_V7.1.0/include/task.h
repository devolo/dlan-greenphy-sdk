...
/**
 * task. h
 * <PRE>signed short uxTaskIsSchedulerRunning( void );</PRE>
 *
 * @return Boolean, true if the scheduler is running.
 *
 * \page uxTaskIsSchedulerRunning uxTaskIsSchedulerRunning
 * \ingroup TaskUtils
 */
signed portBASE_TYPE uxTaskIsSchedulerRunning( void ) PRIVILEGED_FUNCTION;
